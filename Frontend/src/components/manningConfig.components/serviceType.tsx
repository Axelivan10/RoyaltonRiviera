...
function serviceType() {
  ...
  const [relationsServiceType, setRelationsServiceType] = useState<
    relationsAll[]
  >([]);
  ...
  useEffect(() => {
    ...
    const transformedData = Object.entries(selectedServiceTypes).map(
      ([locationId, selectId]) => ({
  ...
  const activeInputById = (id: number) => {
    ...
    // setIsActivate((prevId) => (prevId === id ? 0 : id));
  };
                ...
                <th
                  ...
                  className={
                    head === "Location"
                      ...
                      : head === "Service Type"
                      ? "sticky top-0 left-0 z-50 bg-blue-gray-50 p-4 border-b border-blue-gray-100"
                      : "sticky top-0 z-50 border-b border-blue-gray-100 bg-blue-gray-50 p-4"
                  }
                >
                  <Typography
                    variant="small"
                  ...
                  <tr key={locationId}>
                    ...
                    <td className="p-4 border-b border-blue-gray-50 w-1/7">
                      <div>
                        <select
                          className={
                            locationId !== isActivate
                              ? "bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-2.5"
                    ...
                    <td className="p-6 border-b border-blue-gray-50 w-1/7 flex items-center justify-center">
                      <div className="flex items-center justify-center gap-x-10">
                        <PlusCircleIcon
                          onClick={() => addNewInsert(locationId)}
                          className="cursor-pointer w-6 h-6 hover:text-colorRoyalton hover:font-semibold"
                        ></PlusCircleIcon>
                        <Checkbox
                          onClick={() => activeInputById(locationId)}
                          ...
                          crossOrigin={undefined}
                          disabled={(isActivate === 0 ? false : locationId !== isActivate)}
                        />
                        {/* <PencilIcon  className="cursor-pointer w-5 h-5 hover:text-colorRoyalton hover:font-semibold"></PencilIcon> */}
                        <TrashIcon
                          onClick={() => DeleteInputById(locationId)}
                          className="cursor-pointer w-5 h-5 hover:text-red-500 hover:font-semibold"
                        ></TrashIcon>
                      </div>
                    </td>
                  </tr>
